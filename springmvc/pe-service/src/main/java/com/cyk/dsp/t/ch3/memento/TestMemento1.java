package com.cyk.dsp.t.ch3.memento;
...
class DatingGameWin extends JFrame implements ActionListener {
    ...
    DatingGameWin() {
        ...
        FileName = "D:\\0nRun\\springmvc\\pe-service\\src\\main\\resources\\pic\\memento\\四大美女.jpg";
    ...
    void showPicture(String name) {
        ...
        EastJP.repaint(); //刷新屏幕
        you.setWife(name);
        FileName = "D:\\0nRun\\springmvc\\pe-service\\src\\main\\resources\\pic\\memento\\" + name + ".jpg";
        g = new JLabel(new ImageIcon(FileName), JLabel.CENTER);
        EastJP.add(g);
